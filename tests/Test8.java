...
/**
 * Class to represent Test 8.
 * Test : When max bids are equal in auction 4, the client with most wins which is client id 4 gets the priority and wins.
...
public class Test8 {
    ...
    public static void run() {
        ...
        Produs product4 = ProductFactory.create(4, "furniture4", 39.0, 2019, "modern-type", "wood");
        ...
        Bid bid21 = new Bid.Builder().withClient(client2).withMaxAmount(32.0).withStepWiseBidAmounts(4.0, 6.0, 20.9, 32.0).build();
        ...
        Bid bid62 = new Bid.Builder().withClient(client6).withMaxAmount(40.0).withStepWiseBidAmounts(3.0, 11.9, 20.0, 40.0).build();
        ...
        casaDeLicitatii.placeBid(4, bid42);
