...
/**
 * Class to represent Test 7.
 * Test : Commission is calculated for legal entities with greater than 25 participation count. (Category C4 commission)
 *        All products are sold
 *        Broker cleans sold products
 *        Administrator adds new products
 *
 * NOTE: In order to make the participation count greater than 25, the setter method is used to explicitly set the participation count.
 */
public class Test7 {
    /**
    ...
    public static void run() {
        ...
        // Explicitly setting the participation count to more than 25 just for creating the test scenario
        client2.setNrParticipari(30);
        client4.setNrParticipari(30);
