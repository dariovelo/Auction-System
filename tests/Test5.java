...
/**
 * Class to represent Test 5.
 * Test : Commission is calculated for all the individual entities with greater than 5 participation count. (Category C2 commission)
 *        All products are sold
 *        Broker cleans sold products
 *        Administrator adds new products
 *
 * NOTE: In order to make the participation count greater than 5, the setter method is used to explicitly set the participation count.
 */
public class Test5 {
    /**
    ...
    public static void run() {
        ...
        // Explicitly setting the participation count to more than 5 just for creating the test scenario
        client1.setNrParticipari(10);
        client3.setNrParticipari(10);
        client6.setNrParticipari(10);
        ...
        Bid bid11 = new Bid.Builder().withClient(client1).withMaxAmount(50.0).withStepWiseBidAmounts(3.0, 11.9, 30.0, 50.0).build();
        ...
        Bid bid41 = new Bid.Builder().withClient(client4).withMaxAmount(20.0).withStepWiseBidAmounts(5.0, 11.9, 10.0, 19.00).build();
        Bid bid51 = new Bid.Builder().withClient(client5).withMaxAmount(41.0).withStepWiseBidAmounts(3.0, 21.9, 22.0, 41.0).build();
        Bid bid12 = new Bid.Builder().withClient(client2).withMaxAmount(50.0).withStepWiseBidAmounts(3.0, 11.9, 30.0, 50.0).build();
        Bid bid61 = new Bid.Builder().withClient(client6).withMaxAmount(100.0).withStepWiseBidAmounts(33.0, 41.9, 50.0, 100.0).build();
        Bid bid22 = new Bid.Builder().withClient(client1).withMaxAmount(60.0).withStepWiseBidAmounts(10.0, 20.0, 30.0, 60.0).build();
