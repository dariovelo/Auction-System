...
/**
 * Class to represent Test 9.
 * Test : Product sold attribute and product sold price is updated after the auction
 *        Two products are not sold as the minimum price of the product id not met in the final step.
...
public class Test9 {
    ...
    public static void run() {
        ...
        Licitatie licitatie3 = new Licitatie.Builder().withId(3).withNoParticipants(2).withNoMaximStep(5).withIdProduct(3).build();
        Licitatie licitatie4 = new Licitatie.Builder().withId(4).withNoParticipants(3).withNoMaximStep(3).withIdProduct(4).build();
        ...
        System.out.println("Product 1 => sold: " + product1.isVandut() + ", sold price: " + product1.getPretVanzare());
        System.out.println("Product 2 => sold: " + product2.isVandut() + ", sold price: " + product2.getPretVanzare());
        System.out.println("Product 3 => sold: " + product3.isVandut() + ", sold price: " + product3.getPretVanzare());
        System.out.println("Product 4 => sold: " + product4.isVandut() + ", sold price: " + product4.getPretVanzare());
