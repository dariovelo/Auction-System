...
/**
 * Class to represent Test 1.
 * Test : All products are sold
 ...
 *        Client participation count are updated
 *        Client win count is updated
 */
public class Test1 {
    /**
    ...
    public static void run() {
        ...
        System.out.println("Client 1 => participation: " + client1.getNrParticipari() + ", auction wins: " + client1.getNrLicitatiiCastigate());
        System.out.println("Client 2 => participation: " + client2.getNrParticipari() + ", auction wins: " + client2.getNrLicitatiiCastigate());
        System.out.println("Client 3 => participation: " + client3.getNrParticipari() + ", auction wins: " + client3.getNrLicitatiiCastigate());
        System.out.println("Client 4 => participation: " + client4.getNrParticipari() + ", auction wins: " + client4.getNrLicitatiiCastigate());
        System.out.println("Client 5 => participation: " + client5.getNrParticipari() + ", auction wins: " + client5.getNrLicitatiiCastigate());
        System.out.println("Client 6 => participation: " + client6.getNrParticipari() + ", auction wins: " + client6.getNrLicitatiiCastigate() + "\n\n");
    }

    /**

     * Method to sleep the thread until the logs are printed.
     *      When running in parallel, the system will behave in the expected way and the logs will be printed  in parallel due to multithreading.
